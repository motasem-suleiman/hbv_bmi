...
"""Basic Model Interface implementation for the  Hydrologiska Byråns Vattenbalansavdelning (HBV) model."""
...
class HbvBmi(Bmi):
    ...
    def __init__(self):
        """Create a HbvBmi model that is ready for initialization."""
        self._model: "HbvBmi"
        self._values = {}
        self._var_units = {}
        self._var_loc = "node"
    ...
    def initialize(self, filename=None):
        ...
        if filename is None:
            ...
            with open(filename, "r") as file_obj:
                self._model = HBV.from_file_like(file_obj.read())
        else:
            self._model = HBV.from_file_like(filename)
        ...
        self._values = {"atmosphere_water__precipitation_leq-volume_flux"      : self._model.ppt_mm,
                        ...
                        "land_surface_water__potential_evaporation_volume_flux": self._model.pet_mm,
                        "land_surface_water__runoff_volume_flux"               : self._model.Qgen_routed_mm,
                        "land_surface_water__evaporation_volume_flux"          : self._model.AET_mm,
                        "snowpack__liquid-equivalent_depth"                    : self._model._SP_mm,
                        "land_surface_water__depth"                            : self._model._WC_mm,
                        "soil_water_unsat-zone__thickness"                     : self._model._SM_mm,
