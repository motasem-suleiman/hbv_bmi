...
from SnowRoutine import HBV_SNOW


class HBV_SNOWBmi(Bmi):
    ...
    _output_var_names = ("soil_surface_water__infiltration_volume_flux",
    ...
    def initialize(self, filename=None):
        ...
        """
        if filename is None:
            self._model = HBV_SNOW()
        elif isinstance(filename, str):
            with open(filename, "r") as file_obj:
                self._model = HBV_SNOW.from_file_like(file_obj.read())
        else:
            self._model = HBV_SNOW.from_file_like(filename)
